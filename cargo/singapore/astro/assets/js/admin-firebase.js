...
export function listenCargoGateway({ agent="ASTRO", tsPort="SINGAPORE" }, cb){
  ...
  return onSnapshot(qy, (snap)=>{
    ...
    snap.forEach(docSnap=>{
      ...
      // filter by agent/tsPort so astro page only sees astro-sg records
