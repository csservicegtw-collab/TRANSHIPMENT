import { fetchTrackingByBL, normalizeBL } from "../../js/tracking_firebase.js";
...
function renderHeader(data, bl){
  ...
  $("destText").textContent = ship.destination || "-";
  $("vesselText").textContent = master.motherVessel || "-";
  $("etaText").textContent = ship.etaPod || "-";
